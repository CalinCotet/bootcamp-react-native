export const GEO_MAP_URL = 'https://api.mapbox.com/geocoding/v5/mapbox.places/';
export const LIBRARIES_URL = 'http://rn-bootcamp2021.mocklab.io/v1/libraries';
export const LOGIN_URL = 'http://rn-bootcamp2021.mocklab.io/v1/login';
